...
package com.hendrix.starling.text.bidiTextField
{
   ...
   */
  public class BidiTextField extends DisplayObjectContainer
  {
     ...
     * 
     */
    private var _isTrancted:Boolean;
    ...
    public function BidiTextField(width:int, height:int, text:String, fontName:String="Verdana",
    ...
    private function createComposedContents():void
    {
      ...
      var bitmapFont:BidiBitmapFont = getBitmapFont(mFontName);
      ...
      bitmapFont.bidiLevel = bidiLevel;
      bitmapFont.fillQuadBatch(mQuadBatch,
        width, height, mText, mFontSize, mColor, hAlign, vAlign, mAutoScale, mKerning, isTrancted);
      
      _hasTrancted          = bitmapFont.hasTrancted;
      _tranctationPosition  = bitmapFont.tranctationPosition;
    ...
    public function set fontName(value:String):void
    {
      if (mFontName != value)
      {
        if (value == BidiBitmapFont.MINI && bitmapFonts[value] == undefined)
          registerBitmapFont(new BidiBitmapFont());
    ...
    public static function registerBitmapFont(bitmapFont:BidiBitmapFont, name:String=null):String
    {
    ...
    public static function getBitmapFont(name:String):BidiBitmapFont
    {
